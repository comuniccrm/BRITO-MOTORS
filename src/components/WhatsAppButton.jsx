...
const WhatsAppButton = () => {
  ...
  const phoneNumber = settings.whatsapp_number || '5511995819077';

  const handleClick = () => {
    const message = "Olá! Vi o site da Brito Motors e gostaria de mais informações.";
    window.open(`https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`, '_blank');
  };

  return (
    <div className="whatsapp-fab-container">
      <button className="whatsapp-fab" onClick={handleClick} title="Fale Conosco no WhatsApp">
        <svg 
          viewBox="0 0 448 512" 
          width="34" 
          height="34" 
